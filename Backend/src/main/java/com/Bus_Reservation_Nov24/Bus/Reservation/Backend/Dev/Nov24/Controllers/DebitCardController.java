...
public class DebitCardController {
        ...
        public ResponseEntity<Void> setDebitCardDetails(@RequestBody DebitCardDetails dcdetails){
          ResponseEntity<Void> savedDebitCardDetails =  service.setDebitCardDetails(dcdetails);
